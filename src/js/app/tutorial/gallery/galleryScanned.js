    ...
    [
      {
        ...
        description: `Congratulations! <strong>The Omega Conservatory</strong> is now open to visitors. <strong>The gallery</strong> must have an instrument revealed for it to remain open.`,
        actions: [
          {
            label: 'Next tutorial',
          }
