  ...
  onUpdate: function () {
    ...
    [
      ...
      },
      {
        ...
        }[app.tutorial.getInputPreference()]) + ` to extend <strong>the reach</strong> to its next zoom level. You may ` + ({
        ...
        }[app.tutorial.getInputPreference()]) + ` to zoom out from any level at any time. Zoom in to proceed.`,
        actions: [
          {
