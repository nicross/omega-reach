app.controls.interactions = (() => {
  ...
  function updateMouse() {
    ...
    if (mouseAllowed && engine.input.mouse.isButton(0)) {
      ...
      mousePrimaryPoint.depth = engine.fn.accelerateValue(mousePrimaryPoint.depth || 0, 1, 12)
    ...
    if (mouseAllowed && engine.input.mouse.isButton(2)) {
      ...
      mouseSecondaryPoint.depth = engine.fn.accelerateValue(mouseSecondaryPoint.depth || 0, 1, 12)
